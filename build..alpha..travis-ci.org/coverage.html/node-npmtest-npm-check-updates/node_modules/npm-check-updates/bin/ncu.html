...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-npm-check-updates/node_modules/npm-check-updates/bin/ncu</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-npm-check-updates/node_modules/npm-check-updates/bin/ncu</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-npm-check-updates/node_modules/npm-check-updates/bin/</a> &#187; ncu</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >updateNotifier({pkg: pkg})</span>
    .notify({defer: false});
&nbsp;
<span class="cstat-no" title="statement not covered" >program</span>
    ...
    .option('-v, --version', pkg.version, <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >console.log(pkg.version); <span class="cstat-no" title="statement not covered" ></span>process.exit(0); </span>})
    .option('-V', '', <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >console.log(pkg.version); <span class="cstat-no" title="statement not covered" ></span>process.exit(0); </span>});
&nbsp;
<span class="cstat-no" title="statement not covered" >program.parse(process.argv);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >program.cli = true;</span>
<span class="cstat-no" title="statement not covered" >program.filter = program.args.join(' ') || program.filter;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >ncu.run(program);</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
